...
public class TheClient {
	...
	if( !this.selectApplet() ) {
      ...
      //4 dernier byte coresspond a 1000
	    byte[] cmd_2= { (byte)0xBC, (byte)0x20, (byte)0x00, (byte)0x00, (byte)0x04, (byte)0x31, (byte)0x30, (byte)0x30, (byte)0x30};
	    System.out.println(" // Verify pin=1000 // 63 00 Error //Authentication fail");
            cmd = new CommandAPDU( cmd_2 );
            resp = this.sendAPDU( cmd, DISPLAY );
      //4 dernier byte correspond à 0000
	    ...
	    System.out.println(" // Verify pin=0000 // 90 00 = SW_NO_ERROR ");
            ...
            resp = this.sendAPDU( cmd, DISPLAY );
      //meme command que cmd1_ mais vu qu'on s'est authentifier en cmd3_ cela marchera
